...
def main():
    parser = argparse.ArgumentParser(description='Real-time RAG Application Orchestrator')
    parser.add_argument('command', choices=['ingest', 'process', 'embed', 'api', 'dashboard', 'all'],
